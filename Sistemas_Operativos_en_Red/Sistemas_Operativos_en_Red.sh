...
echo -e "${CYAN}A${NC}${BLUE})${NC} ${YELLOW}Primera${NC}"
...
case $opcion in
    a)
	echo -e "${CYAN}Ha seleccionado la ${YELLOW}Primera${CYAN} opción.${NC}"
	;;
    b)
	echo -e "${CYAN}Ha seleccionado la ${YELLOW}Segunda${CYAN} opción.${NC}"
	;;
    c)
	echo -e "${CYAN}Ha seleccionado la ${YELLOW}Tercera${CYAN} opción.${NC}"
	;;
    d)
    	echo " "
