...
RUTA_SOR="Sistemas_Operativos_en_Red"

#SErvicios en REd
SERE="SErvicios en REd"
RUTA_SERE="SErvicios_en_REd"
...
echo -e "${CYAN}A${NC}${BLUE})${NC} ${YELLOW}$SEIN${NC}"
echo -e "${CYAN}B${NC}${BLUE})${NC} ${YELLOW}$SOR${NC}"
echo -e "${CYAN}C${NC}${BLUE})${NC} ${YELLOW}$SERE${NC}"
...
case $opcion in
    a)
    	echo " "
        echo -e "${CYAN}Ha seleccionado ${YELLOW}$SEIN${NC}"
        sleep 3
        ./$RUTA_SEIN/$RUTA_SEIN.sh
        ;;
    b)
    	echo " "
        echo -e "${CYAN}Ha seleccionado ${YELLOW}$SOR${NC}"
        sleep 3
        ./$RUTA_SOR/$RUTA_SOR.sh
        ;;
    c)
    	echo " "
        echo -e "${CYAN}Ha seleccionado ${YELLOW}$SERE${NC}"
        sleep 3
        ./$RUTA_SERE/$RUTA_SERE.sh
        ;;
    d)
    	echo " "
    ...
    *)
    	echo " "
        echo -e "${BOLD_RED}Opción no válida. Intente de nuevo.${NC}"
        ;;
esac
